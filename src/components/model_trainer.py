...
from sklearn.ensemble import AdaBoostRegressor, GradientBoostingRegressor, RandomForestClassifier, RandomForestRegressor
    ...
    def initiate_model_trainer(self, train_arr, test_arr):
        try:
            ...
            if best_model_score < 0.6:
                raise Custom__exception("No best model found")
